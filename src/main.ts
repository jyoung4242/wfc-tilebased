...
const template = `<div> 
    <canvas \${==>cnv} width="768" height="768"></canvas>
   
</div>`;
// <canvas  \${==>entcnv} width="768" height="768"></canvas>
...
rules[57] = {
  up: [18, 19, 20, 21, 22, 23, 24, 25, 26, 45, 46, 47, 48, 49, 50, 51, 52, 53, 57], // 63, 65, 55,
  down: [0, 1, 2, 3, 4, 5, 6, 7, 8, 27, 28, 29, 30, 31, 32, 33, 34, 35, 57], //54, 55, 56,
  left: [2, 11, 20, 5, 14, 23, 8, 17, 26, 29, 38, 47, 32, 41, 50, 35, 44, 53, 57], //55, 56, 65,
  right: [0, 9, 18, 3, 12, 21, 6, 15, 24, 27, 36, 45, 30, 39, 48, 33, 42, 51, 57], //54, 55, 63,
};
...
rules[66] = {
  up: [54, 55, 56, 57],
  down: [63, 64, 65, 57], //0, 1, 2, 3, 4, 5, 6, 7, 8, 27, 28, 29, 30, 31, 32, 33, 34,
  left: [57],
  right: [57], //0, 9, 48, 3, 12, 21, 6, 15, 24, 27, 36, 45, 30, 39, 48, 33, 42, 51
};
